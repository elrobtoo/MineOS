...
local repositoryURL = "https://raw.githubusercontent.com/elrobtoo/MineOS/master/"
local installerURL = "Installer/"
local EFIURL = "EFI/Minified.lua"

local installerPath = "/TessOS installer/"
...
local function title()
	...
	centrizedText(y, 0x2D2D2D, "TessOS")
	return y + 2
end
...
local installerMenu = menu:addContextMenuItem("TessOS", 0x2D2D2D)
...
addStage(function()
	...
	if not selectedFilesystemProxy.getLabel() then
		selectedFilesystemProxy.setLabel("TessOS HDD")
	end
